package cl.duoc.mssmartrentcatalog.config;
...
@SuppressWarnings("java:S5122") // Ignorando advertencia de CORS para el linter
public class SecurityConfig {

    @SuppressWarnings({"java:S4502", "java:S5122"}) // Ignorando advertencia de CORS para ambiente de pruebas
    @Bean
